...
function tokenClass(token: string) {
  if (token.startsWith("<!--") || token.startsWith("/*") || token.startsWith("//")) return "code-comment";
  ...
  if (/^(true|false|null|undefined|const|let|import|from|export|class|return|new)$/.test(token)) return "code-keyword";
